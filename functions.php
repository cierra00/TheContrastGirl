...
function wp_bootstrap_starter_setup() {
	...
	register_nav_menus( array(
		...
		'header' => esc_html__( 'Header', 'wp-bootstrap-starter' )
	) );
...
/* custom post type bootstrap slider*/
...
function ns_google_analytics() { ?>
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-153990524-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'UA-153990524-1');
  </script>
  <?php
  }
